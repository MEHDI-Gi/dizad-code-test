...
import { MaterialIcons, AntDesign, Foundation, MaterialCommunityIcons, Entypo, FontAwesome5 } from '@expo/vector-icons';
import {
  RewardedAd,
  RewardedAdEventType,
  TestIds,
  ...
  useEffect(() => {
    ...
    const earnedRewardListener = rewardedAd.addAdEventListener(
      ...
      (reward) => {
        ...
        setLivesHeart((prev) => prev + 1); // Add 2 lives as reward
      }
    );
